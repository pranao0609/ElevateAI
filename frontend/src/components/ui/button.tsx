  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        "gradient-primary": "bg-gradient-primary text-primary-foreground hover:shadow-glow hover:scale-105 shadow-lg border-0",
        "gradient-success": "bg-gradient-success text-success-foreground hover:shadow-md hover:scale-105 shadow-lg border-0",
        "hero": "bg-background/10 text-primary-foreground border border-background/20 hover:bg-background/20 backdrop-blur-sm",
      },
      size: {
